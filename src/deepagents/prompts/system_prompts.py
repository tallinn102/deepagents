"""
System prompts for deepagents.

This module contains all system-level prompts used to configure agent behavior.
These prompts are injected into agent system messages to guide their actions and
